    ...
    methods: {
        ...
        toggleview(){
            if(this.mode==='user'){
                ...
                axios.get('/api/getComplaints/user',{ params: { keyword: this.keyword, close_status: this.close_status } }).then(response=>{
                this.complaints = response.data               
                }).catch(errors=>{
                console.log(errors)
                });
             ...
             //   this.$router.push('/admin/usercomplaint');
                ...
                axios.get('/api/getComplaints/service',{ params: { keyword: this.keyword, close_status: this.close_status }}).then(response=>{
                this.complaints = response.data               
            }).catch(errors=>{
                console.log(errors)
            });
                ...
                this.serviceMode = false
                this.title = "All"
                axios.get('/api/getComplaints',{ params: { keyword: this.keyword, close_status: this.close_status }}).then(response=>{
                this.complaints = response.data               
            }).catch(errors=>{
                console.log(errors)
            });
