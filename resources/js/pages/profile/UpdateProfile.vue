...
const updateProfile = () => {
    axios.put('/api/profile', {
        ...
        update_notification: authUserStore.user.update_notification,
    })
    .then((response) => {
                    ...
                    <div class="card">
                        <div class="card-header p-2">
                            <ul class="nav nav-pills">
                                ...
                                <li class="nav-item"><a class="nav-link" href="#changePassword" data-toggle="tab">
                                    <i class="fa fa-key mr-1"></i> Change
                                        Password</a></li>
                                <!-- <li class="nav-item"><a class="nav-link" href="#notification" data-toggle="tab">
                                    <i class="fa-solid fa-envelope m-1"></i>Notification</a></li> -->
                            </ul>
                        </div>
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="tab-pane active" id="profile">
                                    <form @submit.prevent="updateProfile()" class="form-horizontal">
                                        ...
                                        <!-- <div class="form-group row">
                                            <label for="currentPassword" class="col-sm-2 col-form-label">Update Notification</label>
                                            <div class="col-sm-9">
                                                <select v-model="authUserStore.user.update_notification" class="form-control ">
                                                <option value="1">Yes</option>
                                                <option value="0">No</option>
                                            </select>
                                                    <span class="text-danger text-sm" v-if="errors && errors.update_notification">{{ errors.update_notification[0] }}</span>
                                            </div>
                                        </div> -->
                                        <div class="form-group row">
                                            <label for="currentPassword" class="col-sm-2 col-form-label">Update Notification</label>
                                            <div class="col-sm-9">
                                                <input type="radio" v-model="authUserStore.user.update_notification" :value=1 />
                                                <label for="currentPassword" class="m-2">Yes, please send</label>
                                            <input type="radio" v-model="authUserStore.user.update_notification" :value=0 />
                                            <label for="currentPassword" class="m-2">No, don't send me</label>
                                                    <span class="text-danger text-sm" v-if="errors && errors.update_notification">{{ errors.update_notification[0] }}</span>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                ...
                                <div class="tab-pane" id="notification">
                                    <form @submit.prevent="handleChangePassword" class="form-horizontal">
                                        <div class="form-group row">
                                            <label for="currentPassword" class="col-sm-3 col-form-label">Notification Email Setting</label>
                                            <div class="col-sm-9">
                                                <input v-model="authUserStore.user.update_notification" type="checkbox" class="status-update form-check-input" 
                                                checked="true">
                                                    <span class="text-danger text-sm" v-if="errors && errors.current_password">{{ errors.current_password[0] }}</span>
                                            </div>
                                        </div>
