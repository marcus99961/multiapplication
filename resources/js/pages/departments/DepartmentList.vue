            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <button @click="createDepartment"  class="btn-info btn-sm float-right"><i class="fa fa-plus-circle mr-1"></i>New Department</button>
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        ...
        deleteDepartment(){
            axios.post(window.url + 'api/deleteDepartment/' + this.departmentData.id).then(response => {
                this.getDepartments()
            }).catch(errors => {
                console.log(errors)
            }).finally(() => {
